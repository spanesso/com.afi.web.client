...
class MY_Controller extends CI_Controller {
    ...
    protected function _simple_render($skeleton, $view, $style, $script) {
        $this->getLanguageSimpleController($view);
    ...
    protected function _render($skeleton, $view, $menu, $style, $script) {
        ...
        if (!isset($is_logged_in) || $is_logged_in !== true) {
           ...
           redirect("login", 'refresh');
            ...
            if ($menu != null) {
                $menu_view["content_body"] = $this->load->view($menu, array_merge($this->data), true);
                $render_view["menu"] = $this->load->view("template/" . $this->template, $menu_view, true);
                $this->getLanguageController($view, $menu);
            } else {
                $render_view["menu"] = $menu;
                $this->getLanguageSimpleController($view);
            }
